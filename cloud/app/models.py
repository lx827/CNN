...
class Device(Base):
    ...
    dataset = Column(String(50), nullable=True, comment="数据集类型: hustbear/cw/wtgearbox，影响默认超参数选择")
    diagnosis_config = Column(Text, nullable=True, comment="JSON: 诊断超参数覆盖，如 {\"bearing\":{\"kurtosis_threshold\":4.5}}")
